...
import 'reserve_register.dart';

class Booking extends StatefulWidget {
  final String  selecteddistrict;

  const Booking({Key key, this.selecteddistrict}) : super(key: key);
...
_breakfastController.text = widget.selecteddistrict;
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    FirebaseFirestore.instance.collection("booking")
                        .doc(
                        '${time.millisecond}${_vehicle_numberController.text}')
                        .set({
